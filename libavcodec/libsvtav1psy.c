...
const FFCodec ff_libsvtav1psy_encoder = {
    .p.name         = "libsvtav1psy",
    CODEC_LONG_NAME("SVT-AV1-PSY(Scalable Video Technology for AV1) encoder"),
